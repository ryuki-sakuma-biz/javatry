...
//        Ticket ticket = new Ticket(7400); // also here
    ...
    public void test_objectOriented_writing_generalization_extractToAbstract() {
        ...
        log(mysql.buildPagingQuery(13, 13));

        St6PostgreSql postgreSql = new St6PostgreSql();
        log(postgreSql.buildPagingQuery(23, 23));
    }
    ...
    public void test_objectOriented_writing_specialization_extractToConcrete() {
        ...
        log(windows.buildUserResourcePath("Hobby"));
        St6OperationSystem oldWindows = new St6OldWindows("ryuki");
        log(oldWindows.buildUserResourcePath("Hobby"));
    }
